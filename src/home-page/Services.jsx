    ...
    <section className="relative text-[#DCE2E2] py-10 px-16 text-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <CTA2
            ...
            href="/about-us"
            styling="rounded-full bg-[#8AD5B7] text-[#37403D] hover:from-brand-green1 hover:to-brand-green2 font-semibold px-4 text-xl py-4 transition-colors mt-0 w-[90%] lg:w-auto"
          />
        </div>
      </div>
