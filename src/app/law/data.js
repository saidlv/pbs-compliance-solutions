...
export const serviceUpdates = {
  whyLl11: {
    ...
    body: `
      ...
      <p>Enacted in 1980 after a fatal masonry collapse, LL11 (FISP) ensures NYC’s facades never become headlines again</p>
      <p><strong>The Stakes:</strong></p>
      <p>Fines: Up to $10K for missed deadlines or unsafe conditions</p>
      <p>Liability: Falling debris risks lawsuits and reputational ruin</p>
      <p>Safety: Protect pedestrians, tenants, and your property’s Value</p>
    `,
  },
  ourServices: {
    heading: "Our Services:",
    subheadline: "From Inspection to Action, We’ve got you covered",
    services: [
      {
        heading: "1- Facade Inspections",
        subheading: "Your Building’s Health Checkup",
        items: [
          ...
          "SWARMP Analysis: According to NYC LL11 Code, Facades are classified into 3 categories (SAFE, SWARMP, UNSAFE). Through our Experience and Assessments, we make the right decision for you to act upon.",
        ],
      },
      {
        heading: "2- Compliance Reporting:",
        body: `
          <p>We make your Paperwork, Painless</p>
          <p>DOB-Ready Filings: We submit error-free reports electronically, no last minute scrambles</p>
          <p>Transparent Tracking: We Monitor your Compliance status in real-time via our Client Portal</p>
        `,
      },
      {
        heading: "3- Repair & Maintenance Planning:",
        body: `
          <p>We Fix it Once & Fix it Right through our:</p>
          <p>Tailored Strategies where we prioritize repairs by urgency and budget</p>
          <p>Network of Vetted Trusted Contractors & Specialists for Seamless Execution</p>
        `,
      },
    ],
  },
  pbsProcess: {
    heading: "The PBS Process:",
    description: `
      <p>Simple, Fast, Stress Free</p>
      <p>Schedule: Pick a date, we handle your permits and inspections</p>
      <p>Inspect: Daytime, Night-time or weekend scans to minimize disruption</p>
      <p>Report: Get a Clear, actionable plan within hours</p>
      <p>Repair: We Connect you with Pros or manage the project end-to-end</p>
      <p>PBS Handles your Challenges and fix them by taking your pain points on board</p>
      <p>You will never miss your deadlines by partnering with PBS as we have an automated Alert system which reminds you before any deadline. Our Alert System has increased the on-time filing rate by 95%</p>
      <p>Transparent Pricing without any hidden surprises</p>
      <p>We offer Silent inspections through off-hours work to avoid your reputation being damaged among your tenants</p>
      <p>PBS-Vetted Contractors with a good portfolio of Repair and Maintenance work</p>
    `,
  },
  whyChoosePbs: {
    heading: "Why Choose PBS:",
    points: [
      "30+ Years in NYC 1000+ Facades Inspected",
